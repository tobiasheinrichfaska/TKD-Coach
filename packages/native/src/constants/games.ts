...
export const BUILTIN_GAMES: GameDefinition[] = [
  ...
  { id: 'K-ankle-circles', name: 'Ankle Circles', shortName: 'Ankle', sessionPhases: [1], defaultMinutes: 2, ageGroup: 'all', techniques: [], bodyParts: ['ankle', 'calves'], isBuiltIn: true, description: '2–3 circles each direction, both feet.' },
  { id: 'K-knee-circles', name: 'Knee Circles', shortName: 'Knee', sessionPhases: [1], defaultMinutes: 2, ageGroup: 'all', techniques: [], bodyParts: ['knee'], isBuiltIn: true, description: 'Gentle, small amplitude — hinge, no cranking.' },
  { id: 'K-hip-cars', name: 'Hip CARs', shortName: 'Hip CARs', sessionPhases: [1], defaultMinutes: 2, ageGroup: 'all', techniques: [], bodyParts: ['hip', 'core'], isBuiltIn: true, description: 'Quadruped hip controlled articular rotations, spine quiet.' },
  { id: 'K-scorpion', name: 'Scorpion', shortName: 'Scorpion', sessionPhases: [1], defaultMinutes: 2, ageGroup: 'all', techniques: [], bodyParts: ['hip', 'spine', 'core'], isBuiltIn: true, description: 'Dynamic, hip-led; build gradually (low-back load).' },
  { id: 'K-spinal-flow', name: 'Spinal Flow', shortName: 'Spinal', sessionPhases: [1], defaultMinutes: 2, ageGroup: 'all', techniques: [], bodyParts: ['spine', 'shoulders', 'core'], isBuiltIn: true, description: 'cat → puppy → cow → cobra → cat, then reverse.' },

  // ===== Phase 2 · Dynamic warm-up (from the protocol) =====
  { id: 'K-leg-swings-fb', name: 'Leg Swings — front/back', shortName: 'Swings FB', sessionPhases: [2], defaultMinutes: 2, ageGroup: 'all', techniques: ['ap-chagi'], bodyParts: ['hip', 'hamstrings', 'hip-flexors'], isBuiltIn: true, description: '10/leg, full relaxed range.' },
  ...
  { id: 'D-seated-forward-fold', name: 'Seated Forward Fold', shortName: 'Seated Fold', sessionPhases: [4], defaultMinutes: 1, ageGroup: 'all', techniques: [], bodyParts: ['hamstrings', 'calves', 'spine'], isBuiltIn: true, description: 'Reach past toes, 30–60s. Tracked: sit-and-reach.' },
  { id: 'D-hip-flexor-lunge', name: 'Hip-Flexor Lunge', shortName: 'Hip Flexor', sessionPhases: [4], defaultMinutes: 1, ageGroup: 'all', techniques: ['ap-chagi'], bodyParts: ['hip', 'quads', 'hip-flexors'], isBuiltIn: true, description: 'Half-kneeling, PNF. Tracked: front split.' },
  { id: 'D-straddle-pancake', name: 'Straddle / Pancake', shortName: 'Straddle', sessionPhases: [4], defaultMinutes: 1, ageGroup: 'all', techniques: ['yop-chagi'], bodyParts: ['adductors', 'hamstrings', 'hip'], isBuiltIn: true, description: 'Back flat, hinge from hips, PNF. Tracked: side split.' },
  { id: 'D-butterfly', name: 'Butterfly', shortName: 'Butterfly', sessionPhases: [4], defaultMinutes: 1, ageGroup: 'all', techniques: [], bodyParts: ['adductors', 'hip'], isBuiltIn: true, description: 'Soles together, knees out.' },
  { id: 'D-downward-dog', name: 'Downward Dog', shortName: 'Down Dog', sessionPhases: [4], defaultMinutes: 1, ageGroup: 'all', techniques: [], bodyParts: ['calves', 'ankle', 'hamstrings', 'shoulders'], isBuiltIn: true, description: 'Pedaling — press heels, alternate bent/straight knee.' },
];
