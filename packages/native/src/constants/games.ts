...
export const BUILTIN_GAMES: GameDefinition[] = [
  ...
  { id: 'K-ankle-circles', name: 'Sprunggelenk-Kreise', shortName: 'Ankle', sessionPhases: [1], defaultMinutes: 2, ageGroup: 'all', techniques: [], bodyParts: ['ankle', 'calves', 'feet'], isBuiltIn: true, description: '2–3 circles each direction, both feet.' },
  { id: 'K-knee-circles', name: 'Knie-Kreise', shortName: 'Knee', sessionPhases: [1], defaultMinutes: 2, ageGroup: 'all', techniques: [], bodyParts: ['knee', 'quads'], isBuiltIn: true, description: 'Gentle, small amplitude — hinge, no cranking.' },
  { id: 'K-hip-cars', name: 'Hüft-CARs', shortName: 'Hip CARs', sessionPhases: [1], defaultMinutes: 2, ageGroup: 'all', techniques: [], bodyParts: ['hip', 'core', 'hip-rotators'], isBuiltIn: true, description: 'Quadruped hip controlled articular rotations, spine quiet.' },
  { id: 'K-scorpion', name: 'Skorpion', shortName: 'Scorpion', sessionPhases: [1], defaultMinutes: 2, ageGroup: 'all', techniques: [], bodyParts: ['hip', 'spine', 'core', 'lower-back', 'hip-flexors'], isBuiltIn: true, description: 'Dynamic, hip-led; build gradually (low-back load).' },
  { id: 'K-spinal-flow', name: 'Wirbelsäulen-Flow', shortName: 'Spinal', sessionPhases: [1], defaultMinutes: 2, ageGroup: 'all', techniques: [], bodyParts: ['spine', 'shoulders', 'core', 'lower-back'], isBuiltIn: true, description: 'cat → puppy → cow → cobra → cat, then reverse.' },

  // ===== Phase 2 · Dynamic warm-up (from the protocol) =====
  { id: 'K-leg-swings-fb', name: 'Beinschwünge — vor/zurück', shortName: 'Swings FB', sessionPhases: [2], defaultMinutes: 2, ageGroup: 'all', techniques: ['ap-chagi', 'naeryo-chagi'], bodyParts: ['hip', 'hamstrings', 'hip-flexors', 'glutes'], isBuiltIn: true, description: '10/leg, full relaxed range.' },
  { id: 'K-leg-swings-lat', name: 'Beinschwünge — seitlich', shortName: 'Swings Lat', sessionPhases: [2], defaultMinutes: 2, ageGroup: 'all', techniques: ['dollyo-chagi', 'yop-chagi', 'bandal-chagi', 'huryeo-chagi'], bodyParts: ['hip', 'adductors', 'glutes', 'hip-rotators'], isBuiltIn: true, description: '10/leg — direct roundhouse/side-kick prep.' },
  { id: 'K-march-knee-heel', name: 'Knie-zur-Brust + Ferse-zum-Gesäß', shortName: 'March', sessionPhases: [2], defaultMinutes: 2, ageGroup: 'all', techniques: ['ap-chagi'], bodyParts: ['hip', 'knee', 'quads', 'hip-flexors'], isBuiltIn: true, description: 'Walking or march in place.' },
  { id: 'K-footwork-skip', name: 'Beinarbeit / Hüpfen', shortName: 'Footwork', sessionPhases: [2], defaultMinutes: 1, ageGroup: 'all', techniques: ['footwork'], bodyParts: ['calves', 'ankle', 'full-body', 'feet', 'coordination'], isBuiltIn: true, description: 'Skip/shuffle 30–60s — raises HR.' },
  { id: 'K-neck-refocus', name: 'Nacken-Rotation + Refokus', shortName: 'Neck', sessionPhases: [2], defaultMinutes: 1, ageGroup: 'all', techniques: [], bodyParts: ['visual', 'vestibular', 'gaze-stability', 'neck', 'spine'], isBuiltIn: true, description: 'Gentle; mild dizziness = vestibular stimulus.' },
  { id: 'K-single-leg-balance', name: 'Einbein-Balance', shortName: 'Balance', sessionPhases: [2], defaultMinutes: 1, ageGroup: 'all', techniques: [], bodyParts: ['proprioception', 'vestibular', 'balance', 'ankle', 'hip', 'core', 'feet'], isBuiltIn: true, description: '20–30s/side, eyes open → closed.' },

  // ===== Phase 4 · Static stretches (from the protocol) =====
  { id: 'D-standing-forward-fold', name: 'Stehende Vorbeuge', shortName: 'Fwd Fold', sessionPhases: [4], defaultMinutes: 1, ageGroup: 'all', techniques: [], bodyParts: ['hamstrings', 'calves', 'spine', 'lower-back'], isBuiltIn: true, description: 'Hinge & hang, 30–60s. Tracked: forward fold.' },
  { id: 'D-seated-forward-fold', name: 'Sitzende Vorbeuge', shortName: 'Seated Fold', sessionPhases: [4], defaultMinutes: 1, ageGroup: 'all', techniques: [], bodyParts: ['hamstrings', 'calves', 'spine', 'lower-back'], isBuiltIn: true, description: 'Reach past toes, 30–60s. Tracked: sit-and-reach.' },
  { id: 'D-hip-flexor-lunge', name: 'Hüftbeuger-Ausfallschritt', shortName: 'Hip Flexor', sessionPhases: [4], defaultMinutes: 1, ageGroup: 'all', techniques: ['ap-chagi', 'naeryo-chagi'], bodyParts: ['hip', 'quads', 'hip-flexors', 'glutes'], isBuiltIn: true, description: 'Half-kneeling, PNF. Tracked: front split.' },
  { id: 'D-straddle-pancake', name: 'Grätsche / Pancake', shortName: 'Straddle', sessionPhases: [4], defaultMinutes: 1, ageGroup: 'all', techniques: ['yop-chagi', 'dollyo-chagi'], bodyParts: ['adductors', 'hamstrings', 'hip', 'hip-rotators'], isBuiltIn: true, description: 'Back flat, hinge from hips, PNF. Tracked: side split.' },
  { id: 'D-butterfly', name: 'Schmetterling', shortName: 'Butterfly', sessionPhases: [4], defaultMinutes: 1, ageGroup: 'all', techniques: [], bodyParts: ['adductors', 'hip', 'hip-rotators', 'glutes'], isBuiltIn: true, description: 'Soles together, knees out.' },
  { id: 'D-downward-dog', name: 'Herabschauender Hund', shortName: 'Down Dog', sessionPhases: [4], defaultMinutes: 1, ageGroup: 'all', techniques: [], bodyParts: ['calves', 'ankle', 'hamstrings', 'shoulders', 'achilles', 'spine'], isBuiltIn: true, description: 'Pedaling — press heels, alternate bent/straight knee.' },
];
